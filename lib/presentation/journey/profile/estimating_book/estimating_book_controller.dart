...
class EstimatingBookController extends CoreController {
  ...
  EstimatingBookController(this._bookUsecase);
  ...
  Future<void> _getHiringBook({bool isLoadmore = false}) async {
    ...
    final res = await _bookUsecase.getEstimatedBook(context, _page, _pageSize);
    if (!isLoadmore) {
