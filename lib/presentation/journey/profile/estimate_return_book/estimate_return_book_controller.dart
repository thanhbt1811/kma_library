...
class EstimateReturnBookController extends CoreController {
  ...
  EstimateReturnBookController(this._bookUsecase);
  ...
  Future<void> _getHiringBook({bool isLoadmore = false}) async {
    ...
    final res =
        await _bookUsecase.getEstimateReturnBook(context, _page, _pageSize);
    if (!isLoadmore) {
